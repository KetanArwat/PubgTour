...
public class MatchControllerTest {
	...
	public void testSaveNewMatchSuccess() throws Exception {
		...
		mvc.perform(post("/api/v1/matchservice/match").header("authorization", "Bearer " + token)
	...
	public void testGetAllMatches() throws Exception {
		...
		mvc.perform(get("/api/v1/matchservice/matches").header("authorization", "Bearer " + token)
	...
	public void testUpdateMovieSuccess() throws Exception {
		...
		mvc.perform(put("/api/v1/matchservice/{id}", match.getId()).contentType(MediaType.APPLICATION_JSON)
	...
	public void testGetMovieById() throws Exception {
		...
		mvc.perform(get("/api/v1/matchservice/{id}", 1)).andExpect(status().isOk());
